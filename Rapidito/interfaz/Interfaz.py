...
"color: rgb(0, 0, 0);")
        ...
        self.BT_buscar_vehiculo_viaje = QtWidgets.QPushButton(parent=self.tab_viajes)
        self.BT_buscar_vehiculo_viaje.setGeometry(QtCore.QRect(410, 250, 61, 34))
        self.BT_buscar_vehiculo_viaje.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.BT_buscar_vehiculo_viaje.setObjectName("BT_buscar_vehiculo_viaje")
...
"color: rgb(0, 0, 0);")
        ...
        self.pushButton_3 = QtWidgets.QPushButton(parent=self.tab_viajes)
        self.pushButton_3.setGeometry(QtCore.QRect(390, 10, 88, 34))
...
"color: rgb(0, 0, 0);")
        ...
        self.BT_CREAR_viaje.setGeometry(QtCore.QRect(70, 390, 88, 34))
        ...
        self.BT_limpiar_viaje.setGeometry(QtCore.QRect(260, 390, 88, 34))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.BT_buscar_vehiculo_viaje.setText(_translate("MainWindow", "Buscar"))
